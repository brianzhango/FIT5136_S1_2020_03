...
public class Write
{
    ...
    {
        FileInputStream fs=new FileInputStream("/Users/brianzhang/MTMSystem/src/feature/Mission2.xlsx");
        POIFSFileSystem ps=new POIFSFileSystem(fs);
        HSSFWorkbook wb=new HSSFWorkbook(ps);
        HSSFSheet sheet=wb.getSheetAt(0);
        FileOutputStream out = new FileOutputStream("/Users/brianzhang/MTMSystem/src/feature/Mission2.xlsx");
    ...
    public void delete(int location) throws IOException
    {
        ...
        try{HSSFRow row = sheet.getRow(location);
            sheet.removeRow(row);
            FileOutputStream os = new FileOutputStream("/Users/brianzhang/MTMSystem/src/feature/Mission2.xlsx");
            wb.write(os);
            os.close();
        }catch (Exception e) {
            e.printStackTrace();
